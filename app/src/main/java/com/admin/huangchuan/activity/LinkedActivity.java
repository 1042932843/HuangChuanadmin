...
//        linkContent.setLink(etLinked.getText().toString());
        intent.putExtra("tit", TextUtils.isEmpty(etDesc.getText().toString()) ? getString(R.string.link_address) : etDesc.getText().toString());
        intent.putExtra("html", etLinked.getText().toString());
