...
RE.insertImage = function(url, alt,img_id) {
    //todo 2016/4/7
    var html = '<img src="' + url + '" alt="' + alt + '" id="'+img_id+'" height=\"auto\" width=\"95%\"  onclick=\'RE.click_img_callback(getAttribute("id"))\'/>';
    RE.insertHTML(html);
}
...
RE.insertLink = function(url, title) {
    var html="<a href ="+url+" title="+title+" target='__blank'>"+title+"</a>"
    RE.insertHTML(html);
    RE.callback();
}
